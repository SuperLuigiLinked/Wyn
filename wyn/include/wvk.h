...
enum wyn_vk_t
{
    ...
    wyn_vk_BracketR,
    wyn_vk_Plus,
    wyn_vk_Equals = wyn_vk_Plus,
    wyn_vk_Minus,
    wyn_vk_Underscore = wyn_vk_Minus,
    wyn_vk_Accent,

    wyn_vk_Control,
    wyn_vk_Start,
    wyn_vk_Windows = wyn_vk_Start,
    wyn_vk_Command = wyn_vk_Start,
    wyn_vk_Alt,
    wyn_vk_Option = wyn_vk_Alt,
    wyn_vk_Space,
    wyn_vk_Backspace,
    wyn_vk_Delete,
    wyn_vk_Insert,
